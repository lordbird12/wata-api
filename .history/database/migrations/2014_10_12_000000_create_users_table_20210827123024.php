...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('age', 255)->charset('utf8');
            $table->enum('sex', ['M', 'F'])->charset('utf8')->default('M');
            $table->enum('type', ['0', '1', '2'])->charset('utf8')->default('M');
            $table->string('phone', 255)->charset('utf8');
            ...
            $table->string('signature', 255)->charset('utf8')->nullable();
